...
class RSAECNative: NSObject {
    ...
    public func generateCSR(CN: String?, O: String? = nil, C: String? = nil, ST: String? = nil, L: String? = nil, SN: String? = nil, GN: String? = nil, serialNumber: String? = nil, withAlgorithm: String) -> String? {
        ...
        let csrBlock: SecKeyPerformBlock = { privateKey in
            let csr = CertificateSigningRequest(commonName: CN, organizationName: O, countryName: C, stateOrProvinceName: ST, localityName: L, surname: SN, givenName: GN, serialNumber: serialNumber, keyAlgorithm: self.keyAlgorithm)
